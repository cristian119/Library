  ...
  return (
      ...
      <section className="text-center pt-8 sm:pt-16 pb-4 sm:pb-8">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-[37px] sm:text-[56px] font-extrabold mb-6 sm:mb-4 roboto-bold  text-[#7342D6]">
            Australia's most awarded online library platform
          </h1>
          </Fade>

          <Fade direction="up" duration={1500} triggerOnce={true}>
          <h2 className="text-[26px] sm:text-3xl mb-4 sm:mb-8 font-extrabold mt-2 sm:mt-4 roboto-bold text-black">
